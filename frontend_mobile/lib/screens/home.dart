...
class _BuildScreenState extends State<BuildScreen> {
  static const _messages = [
    ...
    "Social Distance",
    "If you can\nStay Home",
    "The Carona Virus can\n stay on a surface\n up to 3 days",
    "Wash your Hands\nfor 20 seconds",
    "Keep Healthy when at Home",
    "Limit your food Sharing",
    "Avoid Crowding",
    "Wear a Mask\nwhen outside",
    "Wear gloves\nwhen outside",
    "Don't Handshake",
        ...
        Container(
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image:
                        AssetImage('assets/images/GrayScaleSpaceBackround.jpg'),
                    fit: BoxFit.cover,
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "\n" + _messages[rng.nextInt(messageLength)],
